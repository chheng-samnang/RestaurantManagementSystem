...
//echo "<h1>".$this->session->userdata('site_lang')."</h1>";
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="wrapper" style="margin-top: 40px;">
        ...
        <nav class="navbar navbar-default navbar-static-top navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('index.php/customer_C/index');?>" style="font-weight: bold; font-size: 24px;"><i class="fa fa-user"></i> Restaurant Management System (ស៊ុបគោពេញចិត្ត)</a>
            </div>
            <!-- /.navbar-header -->
